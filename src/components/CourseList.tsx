...
const CourseList = ({ courses, selectedCourses, toggleCourse }: CourseListProps) => (
    ...
    {Object.entries(courses).map(([key, course]) => {
      ...
      return (
        <div
          ...
          className={`border-2 rounded-lg p-6 flex flex-col shadow-sm cursor-pointer transition-colors relative ${
            isSelected
              ? 'border-gray-800 bg-gray-200'
              : 'border-gray-800 bg-white hover:bg-gray-200'
          }`}
        >
